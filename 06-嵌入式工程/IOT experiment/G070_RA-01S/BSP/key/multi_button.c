/*
 * Copyright (c) 2016 Zibin Zheng <[REDACTED_EMAIL]>
 * All rights reserved
 */
...
void button_init(Button *handle, uint8_t (*pin_level)(uint8_t),
  ...
  handle->button_level =
      !active_level; // initialize to opposite of active level
 ...
 * @param  user_data: user context pointer passed to callback (stored
 * per-button)
 * @retval None
 */
