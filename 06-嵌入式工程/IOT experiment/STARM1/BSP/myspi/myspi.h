...
// 时钟使能定义
#define MYSPI_GPIO_CLK_ENABLE() __HAL_RCC_GPIOA_CLK_ENABLE()

// SCK (SPI Clock) - 输出
#define MYSPI_SCK_PORT GPIOA
#define MYSPI_SCK_PIN GPIO_PIN_3
#define MYSPI_SCK_PIN_LL LL_GPIO_PIN_3
#define MYSPI_SCK(x)                                                           \
  do {                                                                         \
...
#define MYSPI_MOSI_PIN_LL LL_GPIO_PIN_2
#define MYSPI_MOSI(x)                                                          \
  do {                                                                         \
...
#define MYSPI_MISO_PIN GPIO_PIN_5
#define MYSPI_MISO_PIN_LL LL_GPIO_PIN_5
