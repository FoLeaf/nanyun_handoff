...
* 步骤二：安装CH340G驱动，打开DevTools_Hi3861V100_v1.0/usb_serial_driver文件夹。如果选择“**新建工程**”，则路径应该为：“D:\DevEco\resources\toolset\DevTools_Hi3861V100\1.0.0”；如果选择“导入工程”，则路径为：“F:\DevTools_Hi3861V100_v1.0”（具体路径用户在第[REDACTED_IP]节“**开发工具下载**”自己自定义下载的路径）。
...
* 执行下面的命令，查看Ubuntu的IP地址，本文unbuntu的IP地址是 [REDACTED_IP]
...
* <font color='RedOrange '>注意：下方的\\\[REDACTED_IP]\share中的[REDACTED_IP]，是本文ubuntu的IP地址，每个人的ubuntu的IP地址可能不一样，这里需要注意。</font>
...
#### [REDACTED_IP] Monitor 串口打印"helloworld"
...
#### [REDACTED_IP] IoTGpioSetOutputVal()
...
#### [REDACTED_IP] IoTGpioRegisterIsrFunc()
...
#### [REDACTED_IP] IoTGpioGetInputVal()
...
#### [REDACTED_IP] DisconnectWithHotspot()
...
94 
95         IP4_ADDR(&ipaddr,  192, 168, 1, 1);     /* input your IP for example: [REDACTED_IP] */
96         IP4_ADDR(&gateway, 192, 168, 1, 1);     /* input your gateway for example: [REDACTED_IP] */
97         IP4_ADDR(&netmask, 255, 255, 255, 0);   /* input your netmask for example: [REDACTED_IP] */
...
#### [REDACTED_IP] osSemaphoreGetName ()
...
#### [REDACTED_IP] osSemaphoreAcquire ()
...
#### [REDACTED_IP] osSemaphoreRelease ()
...
#### [REDACTED_IP] osSemaphoreGetCount ()
